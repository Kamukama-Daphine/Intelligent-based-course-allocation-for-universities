...
function myFunction() {
  window.print();
					...
					<button class="btn btn-primary"  onclick="myFunction()" role="button">Print Allocation</button>
						...
						<center><h1>MBARARA UNIVERSITY OF SCIENCE AND TECHNOLOGY</h1></center>
						<center><h6>FACULTY OF COMPUTING AND INFORMATICS</h6></center>
						<center><h6>DEPARTMENT OF COMPUTER SCIENCE</h6></center>
...
<h4 style="border-bottom: 1px solid black">FIRST SEMESTER COURSE ALLOCATION 2018/2019 ACADEMIC SESSION (EVENING)</h4>
	...
	<div class="card-datatable table-responsive" style=" width:1000px">
					...
					<center><img src="images/logo.jpg" width="100" height="100"></center>
						...
						<h5 style="border-bottom: 1px solid black">From: HOD, CSD</h5>	<h5 class="sub1">TO: See Distribution Below	</h5>
<h5 style="border-bottom: 1px solid black">Our Ref: FPB/SICT/CSD/CSCA/Vol……..</h5>	 <h5  class="sub1">Date: </h5>
<h4 style="border-bottom: 1px solid black">SECOND SEMESTER COURSE ALLOCATION 2018/2019 ACADEMIC SESSION (EVENING)</h4>
